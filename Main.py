...
while True:
    ...
    if action == "2":
        ...
        for course in courses:
            ...
            if len(assignmentSummary['assignments']) == 0:
                # printd(WHITE + "\tThis class does not have any graded assignments." + END_C)
                pass
...
printd('\n')
# printd(edsby.getSchedule("20170602"))
